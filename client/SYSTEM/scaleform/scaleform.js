...
exports.ScaleForm = Scalefrom;

// mp.game.graphics.requestStreamedTextureDict('spsearaces', false); |доделать| 
// const myScaleForm = new ScaleForm('player_name_01');
// myScaleForm.callFunction('SET_PLAYER_NAME', `<img src="img://spsearaces/lossantos" alt="" /> `);
// const position = new mp.Vector3(-380.3043518066406,-685.6162109375,56.269535064697266);
// mp.events.add('render', () => {
//     if(CheckAtObject(mp.game.joaat('prop_dumpster_01a')))drawSprite('commonmenu', 'shop_trevor_icon_b', 0.5, 0.5, 0.5, 0.5, 0, 255, 255, 255, 255);
//     // arguments - 1) position. 2) rotation. 3) scale.
//     myScaleForm.render3D(position, new mp.Vector3(0, 15, 0), new mp.Vector3(50, 10, 1));
// });
function CheckAtObject(object,radius = 5) {
    return mp.game.object.getClosestObjectOfType(player.position.x, player.position.y, player.position.z, radius, object, false, true, true);
}
